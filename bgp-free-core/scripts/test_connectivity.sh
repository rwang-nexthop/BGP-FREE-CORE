...
# Test 7: VXLAN Connectivity
echo -e "${BLUE}═══════════════════════════════════════════════════════════════════════════════${NC}"
echo -e "${BLUE}Test 7: VXLAN Connectivity (Ring Topology)${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════════════════════════════════════${NC}"
echo ""
...
echo -e "${YELLOW}Leaf 0 (10.0.100.0) → Leaf 3 (10.0.100.3) [non-adjacent]:${NC}"
docker exec clab-folded-clos-LRH-Q3D-0 ping -c 2 10.0.100.3 2>/dev/null && echo -e "${GREEN}✓ PASS${NC}" || echo -e "${RED}✗ FAIL${NC}"
echo ""

echo -e "${YELLOW}Leaf 1 (10.0.100.1) → Leaf 2 (10.0.100.2) [non-adjacent]:${NC}"
docker exec clab-folded-clos-LRH-Q3D-1 ping -c 2 10.0.100.2 2>/dev/null && echo -e "${GREEN}✓ PASS${NC}" || echo -e "${RED}✗ FAIL${NC}"
echo ""

# Test 8: VXLAN Interface Status
echo -e "${BLUE}═══════════════════════════════════════════════════════════════════════════════${NC}"
echo -e "${BLUE}Test 8: VXLAN Interface Status${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════════════════════════════════════${NC}"
echo ""

echo -e "${YELLOW}Leaf 0 VXLAN Interface:${NC}"
docker exec clab-folded-clos-LRH-Q3D-0 ip -d link show vxlan100 2>/dev/null | head -5
echo ""

echo -e "${YELLOW}Leaf 1 VXLAN Interface:${NC}"
docker exec clab-folded-clos-LRH-Q3D-1 ip -d link show vxlan100 2>/dev/null | head -5
echo ""

echo -e "${YELLOW}Leaf 2 VXLAN Interface:${NC}"
docker exec clab-folded-clos-LRH-Q3D-2 ip -d link show vxlan100 2>/dev/null | head -5
echo ""

echo -e "${YELLOW}Leaf 3 VXLAN Interface:${NC}"
docker exec clab-folded-clos-LRH-Q3D-3 ip -d link show vxlan100 2>/dev/null | head -5
echo ""

# Test 9: VXLAN Bridge Status
echo -e "${BLUE}═══════════════════════════════════════════════════════════════════════════════${NC}"
echo -e "${BLUE}Test 9: VXLAN Bridge Status${NC}"
echo -e "${BLUE}═══════════════════════════════════════════════════════════════════════════════${NC}"
echo ""

echo -e "${YELLOW}Leaf 0 Bridge (br100):${NC}"
docker exec clab-folded-clos-LRH-Q3D-0 ip link show br100 2>/dev/null
echo ""

echo -e "${YELLOW}Leaf 1 Bridge (br100):${NC}"
docker exec clab-folded-clos-LRH-Q3D-1 ip link show br100 2>/dev/null
echo ""

echo -e "${YELLOW}Leaf 2 Bridge (br100):${NC}"
docker exec clab-folded-clos-LRH-Q3D-2 ip link show br100 2>/dev/null
echo ""

echo -e "${YELLOW}Leaf 3 Bridge (br100):${NC}"
docker exec clab-folded-clos-LRH-Q3D-3 ip link show br100 2>/dev/null
echo ""
